...
<div class="loginandsignup">
    ...
    <div class="log" id="showsignup"><button class="btn btn-success btndivide">
            <div>Sign Up</div>
        </button></div>
</div>
<div id="main">
    <div class="logpanel">
        <div id="login" class="logclass">
            <h2>LOG IN</h2>
            <form class="form-inline" id="logform">
                <label for="useremail" class="control-label">Email</label>
                <input type="email" class="form-control" id="useremail" name="useremail" placeholder="eg example@gmail.com" style="width:100%" required>
                <label for="userpassword" class="control-label">Password</label>
                <input type="password" id="userpassword" style="width:100%" name="userpassword" class="form-control" placeholder="Please input a valid password" min="6" required>
                <input type="submit" value="Submit" class="btn-primary" class="form-control" style="margin-top:10px" id="loginbtn">
            </form>
            <div class="spinner-border text-secondary none" role="status" id="spinlog">
                <span class="sr-only">Loading...</span>
            </div>
            <small id="logstatus" class="none"></small>
        </div>
        <div id="signup" class="logclass nnone">
            <h2>SIGN UP</h2>
            <form class="needs-validation" id="signform" novalidate>
                <div class="names">
                ...
                <br>
                <div class="spinner-border text-secondary none" role="status" id="spin">
                    <span class="sr-only">Loading...</span>
                </div>
                <small id="status" class="none"></small>
            </form>
        </div>
    </div>
    <script>
